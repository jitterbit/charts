...
{{- define "agent-group.required" -}}
  ...
  {{- required "agent is required!" .Values.agent -}}
    {{- required "agent.registerjson is required!" .Values.agent.registerjson -}}
      ...
      {{- required ".Values.agent.registerjson.username and .Values.agent.registerjson.password or .Values.agent.registerjson.token is required!" (or ( .Values.agent.registerjson.token) (and .Values.agent.registerjson.username .Values.agent.registerjson.password)) -}}
